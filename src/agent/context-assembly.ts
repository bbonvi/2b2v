...
export interface ContextAssemblyInput {
  ...
  /** Stable, periodically rotated conversational samples from other rooms. */
  repertoire: string;
  olderHistory: string;
  newerHistory: string;
...
export const SECTION_DEFS: readonly SectionDef[] = [
  ...
  { label: "Relationships",        role: "developer", cached: false, source: { kind: "field", inputKey: "relationships" } },
