...
export function createSendMessageTool(
  ...
  return {
    ...
    label: "Send Message",
    description:
      "Send a message to chat. Optionally specify chat_id to send to a thread or other chat. Set reply=true to reply to the trigger message (only valid for current chat). Optional: is_voice_message=true sends as audio attachment.",
