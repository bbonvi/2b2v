...
const defaultTrim: TrimConfig = { trimTrigger: 10, trimTarget: 6, windowSize: 20, messageCharLimit: 200 };
...
describe("trimChatHistory", () => {
  ...
  test("handles trim_target equal to trim_trigger", () => {
    const trim: TrimConfig = { trimTrigger: 5, trimTarget: 5, windowSize: 20, messageCharLimit: 200 };
    const msgs = makeMessages(5);
