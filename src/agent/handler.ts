...
function buildRuntimeInstruction(): string {
  return [
    ...
    "For codex_generate_image, set 4k=true only when the user explicitly asks for 4K, UHD, highest/maximum resolution, print-resolution, or a final high-resolution render. Do not set it merely for ordinary high quality, detailed, HD, or good images.",
