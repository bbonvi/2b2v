...
describe("VpnClient", () => {
  ...
  describe("listServers", () => {
    ...
    test("throws VpnApiError on non-200 response", async () => {
      ...
      // oxlint-disable-next-line typescript/await-thenable -- bun:test expect().rejects is thenable
  ...
  describe("deleteProfile", () => {
    test("resolves on success", async () => {
      ...
      // oxlint-disable-next-line typescript/await-thenable -- bun:test expect().resolves is thenable
