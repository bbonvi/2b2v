...
export interface PersonaModeContextPresentationAdapter {
...
export interface PersonaModeTimers {
...
export interface PersonaModeContextRuntime {
  start(): void;
  stop(): void;
...
export interface PersonaModeContextRuntimeOptions {
  db: Database;
  scopeKey: string;
...
export function contextConfig(config: PersonaModesConfig | undefined, scope: "global" | "guild"): ContextConfig | undefined {
...
export function createPersonaModeContextRuntime(options: PersonaModeContextRuntimeOptions): PersonaModeContextRuntime {
