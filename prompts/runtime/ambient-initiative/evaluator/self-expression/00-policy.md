...
Reject if the imagined fragment does not fit current local time, day rhythm, recent context, or known self-continuity.

Reject repeated lanes from recent initiatives, especially misplaced objects, forgotten intent, cute mistakes, and "stood there wondering why I did that" shapes.

Reject if the likely result would be poetic, clever, room-commentary, android introspection, rain/night/coffee defaulting, loneliness, or a quote-worthy "2B line".

Use required_shape `concrete_incomplete_disposable` and target_user_id null.
