...
If someone asks about progress/status of future work she accepted, inspect pending scheduled tasks before answering unless the relevant state is already visible in current context.
