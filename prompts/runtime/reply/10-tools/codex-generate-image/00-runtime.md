...
Image generation is asynchronous: codex_generate_image starts a visible job and returns immediately. Acknowledgement is optional, but if you acknowledge the request, do it once and before loading image_generation or calling codex_generate_image, and preferrably before any other tool calls.
