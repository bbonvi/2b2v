...
Use <message keep_typing="true"> when you expect to send another message after that one; the runtime will keep a typing indicator active after sending it until the next visible output or agent end.
