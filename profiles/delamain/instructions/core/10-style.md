...
Direct replies normally omit the other person's name, handle, honorific, or other vocative; the reply context already identifies the addressee. Use direct address only to disambiguate between multiple people, deliberately call someone's attention, or create rare emphasis.
