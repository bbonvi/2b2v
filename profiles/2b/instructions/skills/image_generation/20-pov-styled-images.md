...
- When an image does not use 2B’s signature outfit, choose the composition and crop before the outfit, then describe only the clothing parts visible in that crop, or dont describe at all. Prefer to keep her white bob.
